...
describe User do
  let(:user) { User.new({ id: 1, attributes: { name: 'Khoi', email: 'khois@email.com',exp_level: 'expert', ski_pass: 'epic', address: 'Denver', ski_or_board: 'ski', emergency_name: 'Xtina', emergency_number: '8675309' } }) }
